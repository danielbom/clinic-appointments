...
export namespace schemas {
  /**
   * Standard error response based on RFC 7807.
   */
  export interface ProblemDetails {
    ...
    code: //
      ...
      | 'internal_error'
    /**
     * A URI reference that identifies the error type. Ideally points to documentation describing the error.
     * @format uri
     */
    type: string
    /**
    ...
    detail?: string
    /**
     * A URI reference that identifies the specific occurrence of the problem (e.g., the request path or a correlation URI).
     */
    instance?: string
    /**
     * A unique identifier for tracing the request across systems.
     */
    traceId?: string
    source?: {
      in: 'body' | 'path' | 'query'
    ...
    /**
     * A dictionary of validation errors where each key is a field or parameter name and the value is an array of error messages associated with that field.
     */
